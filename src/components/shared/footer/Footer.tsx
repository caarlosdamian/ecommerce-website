  ...
  return (
    <footer className="bg-secondary">
      ...
      >
        ...
        <ul className="flex flex-col gap-4 justify-center sm:basis-full sm:flex-row sm:justify-start">
        ...
        <p className="body text-customWhite text-opacity-50 text-center sm:text-start">
          {formatMessage({ id: 'footer_description' })}
        </p>
        <span className="text-customWhite body text-opacity-50 text-center sm:basis-10/12 sm:text-start">
          {formatMessage(
            { id: 'footer_copyright' },
