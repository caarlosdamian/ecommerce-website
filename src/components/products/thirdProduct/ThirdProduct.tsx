...
export const ThirdProduct = () => {
  return (
    <div className="min-w-[327px] h-full mb-9 mx-auto sm:min-w-[689px] lg:min-w-[1110px]">
      <div className="w-full h-full flex flex-col gap-6 sm:flex-row">
        <div className="relative h-[200px] sm:h-[320px] flex-1">
        ...
        <div className="bg-customGray rounded-lg flex flex-col px-6 justify-center items-start h-[200px] gap-8 sm:h-[320px] flex-1 sm:items-center lg:items-start lg:px-24">
